...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="price_1" value="<?php echo ($data[price_1]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">价格2</label>
            <div class="controls">
                <input type="text" class="text input-large" name="price_2" value="<?php echo ($data[price_2]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">价格3</label>
            <div class="controls">
                <input type="text" class="text input-large" name="price_3" value="<?php echo ($data[price_3]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">价格4</label>
            <div class="controls">
                <input type="text" class="text input-large" name="price_4" value="<?php echo ($data[price_4]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">价格5</label>
            <div class="controls">
                <input type="text" class="text input-large" name="price_5" value="<?php echo ($data[price_5]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">盒/箱</label>
            <div class="controls">
                <input type="text" class="text input-large" name="box" value="<?php echo ($data[box]); ?>">
            </div>
        </div>
        <div class="form-item cf">
            ...
            <div class="controls">
                ...
                <input type="hidden" name="img" id="auth_pic" value="<?php echo ($data[img]); ?>"/>
                <div class="upload-img-box">
                    <div class="upload-pre-item"><img src="<?php echo ($data[img]); ?>"/></div>
                </div>
            </div>
        </div>
